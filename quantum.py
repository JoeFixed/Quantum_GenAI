...
def perform_mapping(text):
        ...
        # Create the template
        template_string = '''categorize the following text if it is 'Science' or 'Politics' or 'Information Technology' or 'Economics' or Culture'):
        ...
        Summary:
        '''
        llm = OpenAI(max_tokens=-1,  openai_api_key="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")
        # LLM call
